...
* Improved - Mobile menu is now accessible using the keyboard
...
* Fixed - Default option for the sticky header
* Edit - Code optimized

= 1.4.8 =
Release date - October, 24 - 2021

* Fixed - Issue closing the scroll sidebar on mobile devices
