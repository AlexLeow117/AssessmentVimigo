<?php
/**
 * WP Armonia Typography class
 * 
 * @package Armonia
 * @since 1.0.0
 */
class Armonia_WP_Typography_Control extends WP_Customize_Control {
	/**
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			$this->l10n,
			array(
				'family'      => esc_html__( 'Font Family', 'armonia' ),
				'size'        => esc_html__( 'Font Size',   'armonia' ),
				'weight'      => esc_html__( 'Font Weight', 'armonia' ),
				'color'       => esc_html__( 'Font Color', 'armonia' ),
				'style'       => esc_html__( 'Font Style',  'armonia' ),
				'line_height' => esc_html__( 'Line Height', 'armonia' ),
				'inherit' => esc_html__( 'Click on custom to see changes you made here. Theme default will revert typography to the default values generated by theme', 'armonia' )
			)
		);
	}
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'typography-customizer-controls', get_template_directory_uri() . '/inc/customizer/custom-controls/typography/typography.css', array(), ARMONIA_VERSION, 'all' );
        wp_enqueue_script( 'typography-customizer-controls', get_template_directory_uri() . '/inc/customizer/custom-controls/typography/typography.js', array( 'jquery', 'wp-color-picker' ), ARMONIA_VERSION, true );
	}
		...
		<# } #>
            ...
            <# if ( data.color ) { #>
                <li class="typography-font-color">
                    ...
                    <# } #>
					<input type="text" {{{ data.color.link }}} value="{{ data.color.value }}" class="armonia-color-field" data-default-color="{{ data.color.defaultValue }}"/>
                </li>
            <# } #>
	...
	public function get_font_style_choices() {
		return array(
			'normal'  => esc_html__( 'Normal', 'armonia' ),
			'italic'  => esc_html__( 'Italic', 'armonia' ),
			'oblique' => esc_html__( 'Oblique', 'armonia' )
		);
	}
	...
	public function get_inherit_choices() {
		return array(
			'theme-default'  => esc_html__( 'Theme Default', 'armonia' ),
			'custom'  => esc_html__( 'Custom', 'armonia' )
		);
	}
}