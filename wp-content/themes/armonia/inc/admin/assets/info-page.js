...
jQuery(document).ready(function($) {
    var ajaxUrl = armoniaThemeInfoObject.ajaxUrl, _wpnonce = armoniaThemeInfoObject._wpnonce
    /**
     * On click
     * 
     */
    $(document).on( "click", ".armonia-importer-action-trigger", function() {
        ...
        $.ajax({
            ...
            type: 'post',
            data: {
                "action": "armonia_importer_plugin_action",
                "_wpnonce": _wpnonce,
